...
{	
	...
	private float[] CmatAmb = new float[] { 0.5f, 0.7f, 0.8f, 1.0f };
	private float[] CmatDif = new float[] { 0.8f, 0.9f, 1.0f, 1.0f };
	private float[] CmatSpe = new float[] { 1.0f, 1.0f, 1.0f, 1.0f };
	private float CmatShi = 250.0f;
